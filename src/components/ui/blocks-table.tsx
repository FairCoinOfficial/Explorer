                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="bg-muted/50">
                                        <TableHead className="w-[100px] font-semibold whitespace-nowrap h-8 px-2">Height</TableHead>
                                        <TableHead className="min-w-[200px] lg:min-w-[280px] font-semibold whitespace-nowrap h-8 px-2">Hash</TableHead>
                                        <TableHead className="w-[140px] font-semibold whitespace-nowrap h-8 px-2">Time</TableHead>
                                        <TableHead className="w-[110px] font-semibold whitespace-nowrap h-8 px-2">Transactions</TableHead>
                                        <TableHead className="w-[90px] font-semibold whitespace-nowrap h-8 px-2">Size</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                        ...
                                        <TableRow key={block.height} className={`group hover:bg-muted/50 transition-colors ${index % 2 === 0 ? 'bg-background' : 'bg-muted/20'}`}>
                                            <TableCell className="font-medium whitespace-nowrap py-2 px-2">
                                                <div className="flex items-center gap-2">
                                                    <Link to={`/block/${block.height}`} className="hover:underline text-primary font-semibold transition-colors">
                                            ...
                                            <TableCell className="font-mono text-sm min-w-0 whitespace-nowrap py-2 px-2">
                                                <div className="flex items-center gap-2">
                                                    <Link to={`/block/${block.hash}`} className="hover:underline text-primary transition-colors flex-1 min-w-0">
