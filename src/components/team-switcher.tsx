            ...
            <SidebarMenuItem>
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            <div className="flex aspect-square size-8 items-center justify-center rounded-lg bg-white p-1">
                                <img src="/images/FairCoin-Logo.jpg" alt="FairCoin Logo" width={24} height={24} className="rounded-sm" />
                            </div>
                    ...
                    >
                        ...
                        <DropdownMenuItem onClick={() => handleNetworkSwitch('mainnet')} className="cursor-pointer">
                            <div className="flex size-6 items-center justify-center rounded-sm border bg-white p-0.5">
                                <img src="/images/FairCoin-Logo.jpg" alt="FairCoin" width={16} height={16} className="rounded-xs" />
                            </div>
                            {networks.mainnet.displayName}
                            {currentNetwork === 'mainnet' && <Check className="ml-auto size-4" />}
                            <DropdownMenuShortcut>⌘M</DropdownMenuShortcut>
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => handleNetworkSwitch('testnet')} className="cursor-pointer">
                            <div className="flex size-6 items-center justify-center rounded-sm border bg-white p-0.5">
                                <img src="/images/FairCoin-Logo.jpg" alt="FairCoin" width={16} height={16} className="rounded-xs opacity-60" />
                            </div>
