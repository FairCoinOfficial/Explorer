                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between">
                            ...
                            <Button asChild variant="ghost" size="sm">
                                <Link to="/blocks" className="text-primary hover:text-primary/80">
                ...
                <TabsContent value="transactions" className="space-y-4">
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between">
                            ...
                            <Button asChild variant="ghost" size="sm">
                                <Link to="/tx" className="text-primary hover:text-primary/80">
                                    {t('viewAll')} <ArrowUpRight className="ml-1 h-4 w-4" />
                                </Link>
                            </Button>
                        </CardHeader>
                                            ...
                                            {txFeed.slice(0, 10).map((txid, index) => (
                                                <TableRow key={txid} className={`group hover:bg-muted/50 transition-colors ${index % 2 === 0 ? 'bg-background' : 'bg-muted/20'}`}>
                                                    <TableCell className="font-mono text-sm py-2 px-2">
                                                        <Link to={`/tx/${txid}`} className="hover:underline text-primary font-medium">
                                                            {txid.slice(0, 16)}...
                                                        </Link>
                                                    </TableCell>
