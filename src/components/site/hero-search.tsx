...
export function HeroSearch() {
  return (
    <section className="text-center space-y-4 py-4 md:py-6">
      <h1 className="text-3xl md:text-4xl font-semibold tracking-tight">Explore FairCoin</h1>
      <p className="text-muted-foreground text-sm md:text-base">Search for blocks, transactions, and addresses</p>
