        ...
        <aside className="hidden md:flex flex-col gap-4 p-4 w-60 border rounded-lg bg-background/50 dark:bg-background/30">
            <div className="px-1">
                <nav className="flex flex-col space-y-1">
                    <Link to="/" className="inline-flex items-center gap-2 text-sm font-semibold px-2 py-2 rounded-md hover:bg-accent">
                        <Home className="w-4 h-4" /> <span>Overview</span>
                    </Link>
                    <Link to="/blocks" className="inline-flex items-center gap-2 text-sm px-2 py-2 rounded-md hover:bg-accent">
                        <Layers className="w-4 h-4" /> <span>Blocks</span>
                    </Link>
                    <Link to="/tx" className="inline-flex items-center gap-2 text-sm px-2 py-2 rounded-md hover:bg-accent">
                        <List className="w-4 h-4" /> <span>Transactions</span>
                    </Link>
                    <Link to="/search" className="inline-flex items-center gap-2 text-sm px-2 py-2 rounded-md hover:bg-accent">
