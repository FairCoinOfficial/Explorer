            ...
            <div className="flex-1 space-y-4 p-4 pt-6 md:p-8">
                <div className="flex items-center justify-center h-64">
                    <div className="text-center">
                        <p className="text-lg text-muted-foreground mb-4">Error loading mempool</p>
                        <p className="text-sm text-destructive mb-4">{error}</p>
                        <Button onClick={fetchMempool} variant="outline">
    ...
    return (
        <div className="flex-1 space-y-4 p-4 pt-6 md:p-8">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium">Min Fee Rate</CardTitle>
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium">Avg TX Size</CardTitle>
                        <Database className="h-4 w-4 text-muted-foreground" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                        ...
                        Recent Unconfirmed Transactions
                    </CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Mempool Tips</CardTitle>
                    </CardHeader>
